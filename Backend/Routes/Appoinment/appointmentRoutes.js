...
router.post('/add', requireAuth, attachToken, appointmentController.createAppointment);//ensures only

// 🆕 NEW: Get pending guide requests (MUST be before '/:id')
//Validates session before  allowing user or provider to acess their appoinments.
...
//Prevents unauthorized users from confirming or rejecting appoinments.
