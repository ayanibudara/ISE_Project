...
router.get("/users/report", requireAdmin, async (req, res) => {
  try {
    ...
    doc.fontSize(14).fillColor("white").text("PP", 65, 45);

    // Main title
    doc.fontSize(24).fillColor(primaryColor).text("Pearl Pathways", 130, 30);
    ...
    // Total Users Card
    doc
      .rect(50, yPos, cardWidth, cardHeight)
      .fill("#eff6ff")
      .stroke(primaryColor);
    doc
      .fontSize(24)
      .fillColor(primaryColor)
      .text(userStats.total.toString(), 90, yPos + 15);
    doc
      .fontSize(12)
      .fillColor(secondaryColor)
      .text("Total Users", 70, yPos + 50);

    // Guides Card
    doc
      .rect(50 + cardSpacing, yPos, cardWidth, cardHeight)
      .fill("#f0fdf4")
      .stroke(accentColor);
    doc
      .fontSize(24)
      .fillColor(accentColor)
      .text(userStats.guides.toString(), 90 + cardSpacing, yPos + 15);
    doc
      .fontSize(12)
      .fillColor(secondaryColor)
      .text("Guides", 80 + cardSpacing, yPos + 50);

    // Tourists Card
    doc
      .rect(50 + cardSpacing * 2, yPos, cardWidth, cardHeight)
      .fill("#fef3c7")
      .stroke("#f59e0b");
    doc
      .fontSize(24)
      .fillColor("#f59e0b")
      .text(userStats.tourists.toString(), 90 + cardSpacing * 2, yPos + 15);
    doc
      .fontSize(12)
      .fillColor(secondaryColor)
      .text("Tourists", 75 + cardSpacing * 2, yPos + 50);

    // Package providers Card
    doc
      .rect(50 + cardSpacing * 3, yPos, cardWidth, cardHeight)
      .fill("#fce7f3")
      .stroke("#ec4899");
    doc
      .fontSize(24)
      .fillColor("#ec4899")
      .text(
        userStats.packageProviders.toString(),
        90 + cardSpacing * 3,
        yPos + 15
      );
    doc
      .fontSize(12)
      .fillColor(secondaryColor)
      .text("Providers", 70 + cardSpacing * 3, yPos + 50);
    ...
    users.forEach((user, index) => {
      ...
      doc
        .fillColor("#6b7280")
        .text(new Date(user.createdAt).toLocaleDateString(), 450, yPos);
